...
{
//        textprintf(b,font,8,1,makecol(255,255,255),"%i %i %i %i %i %i %i %i",dsp.volumel[0],dsp.volumel[1],dsp.volumel[2],dsp.volumel[3],dsp.volumel[4],dsp.volumel[5],dsp.volumel[6],dsp.volumel[7]);
//        textprintf(b,font,8,9,makecol(255,255,255),"%i %i %i %i %i %i %i %i",dsp.volumer[0],dsp.volumer[1],dsp.volumer[2],dsp.volumer[3],dsp.volumer[4],dsp.volumer[5],dsp.volumer[6],dsp.volumer[7]);
}
